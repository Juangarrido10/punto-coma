...
RF3. Agregar ítems al pedido (producto y cantidad).
RF4. Aplicar precio por volumen cuando la cantidad de un producto alcanza el umbral definido:

Impresión B/N: desde 100 unidades → $150 c/u

Impresión Color: desde 50 unidades → $400 c/u

Anillado: sin descuento por volumen.
