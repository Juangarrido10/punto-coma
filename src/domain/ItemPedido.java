...
public class ItemPedido {
    ...
    public int precioUnitarioAplicado() {
        return (cantidad >= producto.getUmbralVolumen())
                ? producto.getPrecioVolumen()
                : producto.getPrecio();
    }
    ...
    public String toString() {
        return "%s x%d (unit=%,d) subtotal=%,d"
                .formatted(producto.name(), cantidad, precioUnitarioAplicado(), subtotal());
    }
}
